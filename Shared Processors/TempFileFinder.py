...
#
# Temp as waiting PR merging and release including PR - https://github.com/autopkg/autopkg/pull/742
#

"""See docstring for TempFileFinder class"""
...
__all__ = ["TempFileFinder"]


class TempFileFinder(DmgMounter):
